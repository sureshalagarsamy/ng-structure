angular.module("globalServices", []).factory("globalService", function($http, $q) {
	var globalApi = {};
	...
	globalApi.ajaxPUT = function(url, params, callback) {
		(params.customHeaders != undefined) ? params.customHeaders = params.customHeaders: params.customHeaders = null;
		$http({
			url: url,
			method: "PUT",
			data: params,
